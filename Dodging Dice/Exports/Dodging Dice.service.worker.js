...
const CACHE_NAME = "Dodging Dice-cache";
const OFFLINE_URL = "Dodging Dice.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Dodging Dice.html","Dodging Dice.js","Dodging Dice.wasm","Dodging Dice.pck","Dodging Dice.offline.html","Dodging Dice.icon.png","Dodging Dice.apple-touch-icon.png"];
